...
<!--M/W, 3pm-4pm, or by appointment.  The time and location will be adjusted based on class feedback in the first week of class.-->
...
* **kinematics:** the robot should have a clear, well-thought-out through transmission design facilitated by the concepts taught in this class (and confirmed through analysis).
    ...
    * Selection of motors based on power needs determined via kinematics.
...
## Attendance & Participation^[See the syllabus for details] {.allowframebreaks}
...
## Reorganizing a Team^[see syllabus for full details] {.allowframebreaks}
