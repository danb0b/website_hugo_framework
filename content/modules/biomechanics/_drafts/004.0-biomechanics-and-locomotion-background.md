...
A great review of locomotion through 2000 can be found in [@Dickinson2000]
...
![Asymmetric muscle loading, from [@Dickinson2000]](../../figures-external/dickinson2000/fig03.png){class="img-fluid"}
...
![Froude Number vs. Phase Difference between front and hind lengs in quadrupeds, from [@Alexander1983]](../../figures-external/alexander1983/fig02.png){class="img-fluid"}


The "dynamic similarity hypothesis" by Alexander[@Alexander1976]  identifies similarities across quadrupedal [@Alexander1983] and later bipdeal[@Alexander1984] and hexapedal animals[@Full1990] whereby nondimensionalization of an animal's mechanics can be distilled down to the Froude number, or $\frac{u^2}{gl}$, where $u$ is speed, $g$ is gravity and $l$ is a length scaling factor such as hip height.  This number makes it possible to estimate an animal's dynamics (like a dinosaur's[@Alexander1976]) without direct measurement.

![Froude Number vs. Stride Length and Duty Factor, from [@Alexander1984]](../../figures-external/alexander1984/fig04.png){class="img-fluid"}

### Other Scaling Relationships

![Leg Stiffness vs Mass, from [@Farley1993]](../../figures-external/farley1993/fig03.png){class="img-fluid"}

Leg Stiffness also scales with body mass [@Farley1993].  
...
Bipedal and quadrupeal animals exhibit a variety of gaits, the selection of which seems to minimize energy use or limb displacement [@Alexander1984].  
...
Stiffness and Speed also come into play in  [@McMahon1990]

![Accelerations In Different Animals[@Cavagna1988]](../../figures-external/cavagna1988/fig01b.png)

SLIP model applied to a variety of animals [@Full2000; @Blickhan1993; @Farley1993]:

* Humans [@Cavagna1977]
* Dogs [@Cavagna1977]
* Kangaroos [@Alexander1975]
* Lizards: [@Farley1997]
* Crabs: [@Blickhan1987]
* Cockroaches: [@Full1991a]
* Geckos: 
...
* Stick Insects: [@Cruse1976]
* Crabs: [@Blickhan1987]
* Crayfish [@Klarner1986; @Clarac1982; @Domenici1999]

Elastic Storage and Recovery in Legs [@Ting1994] [@Schmitt2000a]

Benefits cases where animal is accustomed to disturbances [@Kubow1999]
...
* PIV used to visualize flows and compute thrust [@Raffel1998]
